...
-- победы - плателищики неплательщики
select
	payer,
  percentile_cont(0.25) within group (order by wins asc) as p_25,
  percentile_cont(0.50) within group (order by wins asc) as p_50,
